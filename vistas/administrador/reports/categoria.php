...
if(!empty($this->categoria)){
    $nombres = array_column($this->categoria, 'nombre_categoria')[0];
}else{
    $nombres = "";
}
...
<h2>Reporte de Jugadores <?=$nombres?></h2>
<table>
    <thead>
        <tr>
    ...
    <tbody>
        <?php foreach ($this->categoria as $jugador):?>
        <tr>
            <?php
            ...
            <td><?=$jugador['partida_nacimiento']?></td>
